...
```yaml
HeroSection:
  eyebrow: "آزمایشگاه شخصی و مجموعه ابزارهای توسعه"
  title_primary: "RashAI"
  title_tld: ".dev"
  description: "طراحی و مهندسی شده توسط رشا (علی راشدی). ساخت ابزارهای الگوریتمی با بالاترین اثرگذاری مهندسی، جریان‌های کاری ایجنتیک و موتورهای تصمیم‌گیری خودکار مبتنی بر هوش مصنوعی مدرن."
  tags:
